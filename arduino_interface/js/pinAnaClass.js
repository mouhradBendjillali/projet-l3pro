...
this.htmlBase = function() {
		...
		var num = this.getNumber();
            htmlString += "<div class='col-md-1'><span id='pinNumber'" + this.getNumber() + "'>A" + num + "</span></div>";
    ...
    this.htmlInactive = function() {
        ...
        var htmlString = this.htmlBase();
            htmlString += "<div class='col-md-2' id='selectPinA'><select id='pinModeA" + this.getNumber() + "' onchange='updateAna("+ this.getNumber() +")'>";
