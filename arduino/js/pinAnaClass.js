function pinAna(){
    ...
    // Lors de l'affichage de la PIN ANALOGIQUE on selectionne l'affichage qui corespond au mode de la pin. 
    ...
    // Pour le moment seul le mode "Inactive" à été implémenté, afin de pouvoir tester l'affichage. Ici, on créé les éléments de la pin inactive.
  	this.htmlInactive = function() {
        ...
        var htmlString = "";
            ...
            htmlString += "<div class='col-md-1'><span id='pinNumber'" + this.getNumber() + "'>A" + this.getNumber() + "</span></div>";
