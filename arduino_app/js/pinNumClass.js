function pinNum(){
    ...
    this.htmlServo = function() {
        ...
        htmlString += "<div class='col-md-10'><div class='col-md-2'><div id='slider-range-min" + this.getNumber() + "'></div></div>";
    ...
    this.htmlPWM = function() {
        ...
        htmlString += "<option value='SERVO'>SERVO</option>";
        htmlString += "</select></div>";
        htmlString += "<div class='col-md-2'><div id='slider-range-min" + this.getNumber() + "'></div></div>";
